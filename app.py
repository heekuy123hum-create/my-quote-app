...
# ------------------------------------------------------------------
# TAB 2: ลูกค้า (FIX: บันทึก+ลบในปุ่มเดียว, แก้ปัญหาเลขหน้าตาราง + FIX Duplicate ID)
# ------------------------------------------------------------------
with tab2:
    ...
    # เพิ่ม key="btn_save_customer" เพื่อไม่ให้ซ้ำกับปุ่มหน้าสินค้า
    if st.button("💾 บันทึกการเปลี่ยนแปลง (เพิ่ม/ลบ/แก้ไข)", type="primary", use_container_width=True, key="btn_save_customer"):
...
# ------------------------------------------------------------------
# TAB 3: สินค้า (FIX: บันทึก+ลบในปุ่มเดียว, แก้ปัญหาเลขหน้าตาราง + FIX Duplicate ID)
# ------------------------------------------------------------------
with tab3:
    ...
    # เพิ่ม key="btn_save_product" เพื่อไม่ให้ซ้ำกับปุ่มหน้าลูกค้า
    if st.button("💾 บันทึกการเปลี่ยนแปลง (เพิ่ม/ลบ/แก้ไข)", type="primary", use_container_width=True, key="btn_save_product"):
        # ฟังก์ชัน save_data จะจัดการกรองแถวที่ติ๊กลบ และแถวว่างทิ้งให้เอง
