...
with tab2:
    ...
    # *** แก้ไข: รับค่าจากตัวแปร edited_customers โดยตรง ***
    ...
    if st.button("💾 บันทึกการเปลี่ยนแปลง (ลูกค้า)", type="primary"):
        # *** แก้ไข: ส่ง edited_customers (ที่เป็น DataFrame) ไปบันทึก ไม่ใช่ดึงจาก Key ***
...
with tab3:
    ...
    # *** แก้ไข: รับค่าจากตัวแปร edited_products โดยตรง ***
    ...
    if st.button("💾 บันทึกการเปลี่ยนแปลง (สินค้า)", type="primary"):
        # *** แก้ไข: ส่ง edited_products (ที่เป็น DataFrame) ไปบันทึก ***
...
with tab4:
    ...
    if st.session_state.db_history.empty:
        ...
        if st.button("💾 อัปเดตประวัติ (ลบรายการที่เลือก)", type="primary"):
            # *** แก้ไข: ใช้ตัวแปร edited_history โดยตรง ***
